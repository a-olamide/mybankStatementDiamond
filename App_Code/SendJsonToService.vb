...
Public Class SendJsonToService
    ...
    End Sub
    Public Function doJSONFileUploadViaWebService() As String
        ...
        Try
            ...
            Try
                ...
                'oWS.Proxy = proxyVal
                oWS.SendJsonStatement(TicketNo, "8", "mybankStatement88*", oFileInfo.Name, oFileByte, strReturn)

                If strReturn.ToLower = "file sent successfully" Then
                    Return "File Delivered successfully"

                Else
                    '    outcome = BLL._insertStatementUnsentLog(details(0), details(13), details(14), "json", "0")
                    '    If outcome = "Fail" Then Return "fail" Else
                    Return strReturn
                End If
